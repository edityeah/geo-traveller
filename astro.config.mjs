...
// ── Sitemap data, computed from generated post frontmatter ───────────────────
// We parse the built post MDX (written by build-content before astro build) to:
...
try {
  ...
  // Content not generated yet (e.g. local dev without a Notion pull) — fall
  // back to permissive behaviour below.
}
